...
namespace mk
{
    ...
    public:
        ...
        void initialize();
        void begin();
        void draw(const mk::Sprite &sprite, mk::Vector2f position, mk::Vector2f scale = {1, 1});
        void flush();
    ...
    private:
        ...
        void push_sprite_data(const Sprite &sprite, mk::Vector2f position, mk::Vector2f scale);
